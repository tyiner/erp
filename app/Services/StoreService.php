...
class StoreService extends BaseService
{
    ...
    public function getGoodsInfo($storeId, $goodsId)
    {
        ...
        if (empty($goods)) {
            throw new \Exception('商品不存在', 3101);
        }
        ...
        return [
            ...
            'mobile_image' => $goods->mobile_image,
            'goods_master_image' => $goods->goods_master_image,
            'goods_images' => $goods_images,
            'goods_price' => $goods->store_goods->goods_price,
            'goods_market_price' => $goods->store_goods->goods_market_price,
            'cost_price' => $goods->store_goods->cost_price,
            'goods_stock' => $goods->store_goods->goods_stock,
            'goods_content' => $goods->goods_content,
            'goods_content_mobile' => $goods->goods_content_mobile,
            'goods_sale' => $goods->store_goods->goods_sale,
            'purchase_limit' => $goods->store_goods->purchase_limit,
            'purchase_start' => $goods->store_goods->purchase_start,
            'purchase_end' => $goods->store_goods->purchase_end,
            'purchase_point' => $goods->store_goods->purchase_point,
            'created_at' => $goods->created_at->format('Y-m-d H:i:s'),
            'unit' => $goods->store_goods->unit,
            'pack_length' => $goods->store_goods->pack_length,
            'pack_width' => $goods->store_goods->pack_width,
            'pack_height' => $goods->store_goods->pack_height,
            'banner_height' => $goods->store_goods->banner_height,
        ];
    }
}
