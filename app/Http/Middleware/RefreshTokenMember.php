...
class RefreshTokenMember extends BaseMiddleware
{
    /**
    ...
    public function handle($request, Closure $next)
    {
        ...
        try{
            ...
            // 此处捕获到了 token 过期所抛出的 TokenExpiredException 异常，我们在这里需要做的是刷新该用户的 token 并将它添加到响应头中
                ...
                // 使用一次性登录以保证此次请求的成功
                    Auth::guard('member')->onceUsingId($this->auth->manager()->getPayloadFactory()->buildClaimsCollection()->toPlainArray()['sub']);
